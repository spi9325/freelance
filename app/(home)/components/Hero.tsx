    ...
    <section className="max-w-[1440px] mx-auto border border-black mt-2 px-2 py-1">
      <div className="relative md:p-2">
        <Carousel>
          <CarouselContent>
            <CarouselItem>
              <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-6 p-4 md:p-8 border border-blue-700 overflow-hidden">
                {/* Left Content */}
                ...
                {/* Right Image */}
                <div className="border border-black relative w-full lg:w-1/2 h-[500px] md:h-[500px] lg:h-[600px] overflow-hidden flex justify-center items-center">
                  <Image
                    src="/hero-woman.jpg"
                    alt="Hero Image"
                    width={500}
